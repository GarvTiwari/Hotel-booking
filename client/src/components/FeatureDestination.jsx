...
const FeatureDestination = () => {
  ...
  return (
    ...
    <Title title = 'Featured Destination' subTitle = 'Discover our handpicked selection of exceptional properties around the world, offering upparallel luxury and unforgettable experiences.'  />
